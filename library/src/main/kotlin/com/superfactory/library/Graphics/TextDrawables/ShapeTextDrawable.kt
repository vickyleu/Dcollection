package com.superfactory.library.Graphics.TextDrawables
 ...
 */
class ShapeTextDrawable private constructor(builder: Builder) : ShapeDrawable(builder.shape) {
    ...
    open class Builder internal constructor() : IConfigBuilder, IShapeBuilder, IBuilder {
        ...
        internal var shape: RectShape? = null
        ...
        override fun buildRect(text: String, color: Int): ShapeTextDrawable {
            rect()
            return build(text, color)
        }

        override fun buildRoundRect(text: String, color: Int, radius: Int): ShapeTextDrawable {
            roundRect(radius)
            return build(text, color)
        }

        override fun buildRound(text: String, color: Int): ShapeTextDrawable {
            round()
            return build(text, color)
        }

        override fun build(text: String, color: Int): ShapeTextDrawable {
            this.color = color
            this.text = text
            return ShapeTextDrawable(this)
        }
    }
    ...
    interface IBuilder {
        ...
        fun build(text: String, color: Int): ShapeTextDrawable
    }
    ...
    interface IShapeBuilder {
        ...
        fun buildRect(text: String, color: Int): ShapeTextDrawable

        fun buildRoundRect(text: String, color: Int, radius: Int): ShapeTextDrawable

        fun buildRound(text: String, color: Int): ShapeTextDrawable
    }
