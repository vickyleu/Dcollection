...
fun <T> BindingDisposerGenerator.viewCreator(viewBinderComponent: ItemViewBinderComponent, viewModelFactory: () -> ItemViewModel<T>): ViewCreator<T> = ViewCreator(bindingDisposer, viewBinderComponent, viewModelFactory)