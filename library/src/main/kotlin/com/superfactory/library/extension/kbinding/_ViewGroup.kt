...
import com.superfactory.library.extension.generateViewId
import io.reactivex.functions.Consumer

fun ViewGroup.fragment(vararg paths: String, converter: OneWayConverter<*, Fragment> = EmptyOneWayConverter1()) = oneWayPropertyBinding(paths, fragment(this), false, converter)

private fun fragment(container: ViewGroup) = Consumer<Fragment> {
